...
const MovieDetails = (props) => {
  ...
  const castItems = [
    {
      imgSrc: '/src/assets/images/cast/cast-1.png',
      imgAlt: 'Ivan Ivanov',
    },
    {
      imgSrc: '/src/assets/images/cast/cast-2.png',
      imgAlt: 'Ivan Ivanov',
    },
    {
      imgSrc: '/src/assets/images/cast/cast-3.png',
      imgAlt: 'Ivan Ivanov',
    },
    {
      imgSrc: '/src/assets/images/cast/cast-4.png',
      imgAlt: 'Ivan Ivanov',
    },
    {
      imgSrc: '/src/assets/images/cast/cast-5.png',
      imgAlt: 'Ivan Ivanov',
    },
    {
      imgSrc: '/src/assets/images/cast/cast-6.png',
      imgAlt: 'Ivan Ivanov',
    },
    {
      imgSrc: '/src/assets/images/cast/cast-7.png',
      imgAlt: 'Ivan Ivanov',
    },
    {
      imgSrc: '/src/assets/images/cast/cast-8.png',
      imgAlt: 'Ivan Ivanov',
    },
  ]
  const reviewItems = [
        ...
        {seasons && (
          <div className="movie-details__panel movie-details__panel--seasons">
            <div className="movie-details__group movie-details__group--big-gap-y">
              <h3 className="title title--h4">Seasons and Episodes</h3>
              {seasons}
            </div>
          </div>
        )}
        ...
        <div className="movie-details__panel">
          <div className="movie-details__groups">
            <div className="movie-details__group">
              ...
              <div className="movie-details__description">
                <time className="movie-details__year" dateTime="2022">
                  2022
                </time>
              </div>
            </div>
